...
public class MatrixApplicationTest {
    ...
    private static final String INPUT_FILE = "src/test/resources/matrix/matrices";
    private static final String OUTPUT_FILE = "src/test/resources/matrix/matrices_results.txt";
